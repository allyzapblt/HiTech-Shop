...
<div class="box">
    ...
    <section class="container content-section">
        ...
        <div class="shop-items">
            <div class="shop-item">
                <img class="shop-item-image" src="img/products/k1.jpg">
                <span class="shop-item-title">RAZER BlackWidow V3 Mechanical Gaming Keyboard</span>
                <div class="shop-item-details">
                    <span class="shop-item-price">₱ 4595.00</span>
                    <button class="btn btn-primary shop-item-button" type="button">ADD TO CART</button>
                </div>
            </div>

            <div class="shop-item">
                <img class="shop-item-image" src="img/products/k2.jpg">
                <span class="shop-item-title">HP GK400F Mechanical Keyboard</span>
                <div class="shop-item-details">
            ...
            <div class="shop-item">
                <img class="shop-item-image" src="img/products/k3.jpg">
                <span class="shop-item-title">Badwolf BK800 Mechanical Keyboard</span>
                <div class="shop-item-details">
            ...
            <div class="shop-item">
                <img class="shop-item-image" src="img/products/k4.jpg">
                <span class="shop-item-title">Redragon K565 Mechanical Keyboard </span>
                <div class="shop-item-details">
            ...
            <div class="shop-item">
                <img class="shop-item-image" src="img/products/k5.jpg">
                <span class="shop-item-title">Zeus Gaming Keyboard</span>
                <div class="shop-item-details">
            ...
            <div class="shop-item">
                <img class="shop-item-image" src="img/products/k6.jpg">
                <span class="shop-item-title">Gigaware G87 Gaming Keyboard</span>
                <div class="shop-item-details">
                    <span class="shop-item-price">₱ 1000.00</span>
                    <button class="btn btn-primary shop-item-button" type="button">ADD TO CART</button>
                </div>
            </div>

            <div class="shop-item">
                <img class="shop-item-image" src="img/products/k7.jpg">
                <span class="shop-item-title">REDRAGON S107-1 GAMING KEYBOARD </span>
                <div class="shop-item-details">
                    <span class="shop-item-price">₱ 1240.00</span>
                    <button class="btn btn-primary shop-item-button" type="button">ADD TO CART</button>
                </div>
            </div>

            <div class="shop-item">
                <img class="shop-item-image" src="img/products/k8.jpg">
                <span class="shop-item-title">Corsair K95 RGB PLATINUM XT Mechanical Gaming Keyboard</span>
                <div class="shop-item-details">
                    <span class="shop-item-price">₱ 8995.00</span>
                    <button class="btn btn-primary shop-item-button" type="button">ADD TO CART</button>
                </div>
            </div>
