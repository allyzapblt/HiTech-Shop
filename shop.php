    ...
    <section class="container content-section">
        ...
        <div class="shop-items">
            <div class="shop-item">
                ...
                <span class="shop-item-title">DELUX M700A Wired Honeycomb Lightweight Gaming Mouse</span>
                <div class="shop-item-details">
                    <span class="shop-item-price">₱ 580.00</span>
                    <button class="btn btn-primary shop-item-button" type="button">ADD TO CART</button>
                </div>
            </div>
            <div class="shop-item">
                <img class="shop-item-image" src="img/products/ms1.jpg">
                <span class="shop-item-title">Zeus MR002 ( Beez-Hive ) Wired Gaming Mouse RGB Backlight Gaming - Upgraded Version</span>
                <div class="shop-item-details">
                    <span class="shop-item-price">₱ 229.00</span>
                    <button class="btn btn-primary shop-item-button" type="button">ADD TO CART</button>
                </div>
            </div>
            <div class="shop-item">
                <img class="shop-item-image" src="img/products/ms2.jpg">
                <span class="shop-item-title">Fantech Original X9 Thor Macro RGB Gaming Mouse Ideal For Gaming Personal Use And Cafe</span>
                <div class="shop-item-details">
                    <span class="shop-item-price">₱490.00</span>
                    <button class="btn btn-primary shop-item-button" type="button">ADD TO CART</button>
                </div>
            </div>
            <div class="shop-item">
